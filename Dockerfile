...
# MIT-only core (no AGPL PyMuPDF): PDF→EPUB is offloaded to the optional tomeforge
# sidecar (DESPEREAUX_TOMEFORGE_HOST). MOBI/AZW convert in-process via Calibre.
